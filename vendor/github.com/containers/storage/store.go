...
func (s *store) load() error {
	logrus.Debug("getting graph driver,,,")
...
func (s *store) getGraphDriver() (drivers.Driver, error) {
	...
	logrus.Debug("creating driver config...")
	...
	logrus.Debug("creating new driver...")
	driver, err := drivers.New(s.graphDriverName, config)
	if err != nil {
		return nil, err
	}
	logrus.Debug("created new driver")
	s.graphDriver = driver
	s.graphDriverName = driver.String()
	return driver, nil
}
